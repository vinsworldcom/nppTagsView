...
class COption 
{
    public:
        ...
        typedef cpp_base::data_buf<byte_tt> ByteBuf;
...
{
    protected:
        cpp_base::data_buf<TCHAR> _group;
        cpp_base::data_buf<TCHAR> _name;
        COption                   _saved;
    ...
    public:
        ...
        LPCTSTR getOptionGroup() const { 
                    return _group.data() ? _group.data() : _T("\0");
                }
        LPCTSTR getOptionName() const { 
                    return _name.data() ? _name.data() : _T("\0");
                }
...
{
    public:
        LPCTSTR GetIniFilePathName() const { return _iniFilePathName.data(); }
    ...
    protected:
        cpp_base::data_buf<TCHAR> _iniFilePathName;
};
